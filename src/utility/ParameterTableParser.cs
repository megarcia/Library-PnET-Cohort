...
namespace Landis.Library.PnETCohorts
{
    public class ParameterTableParser : TextParser<Dictionary<string, Parameter<string>>>  
    {
        ...
        public ParameterTableParser(string FileName, string KeyWord, List<string> ExpectedRowLabels,
                                    List<string> ExpectedColumnHeaders, bool transposed = false)
        {
        ...
        void CheckHeaderCount(StringReader s, int ReadHeaderLabelsCount)
        {
            ...
            List<string> Terms = new List<string>(headerline.Trim().Split((char[])null, StringSplitOptions.RemoveEmptyEntries));
        ...
        protected override Dictionary<string, Parameter<string>> Parse()
        {
            try
            {
                ...
                while (line.Length == 0)
                    GetNextLine();
                List<string> ReadHeaderLabels  = new List<string>(line.Split((char[])null, StringSplitOptions.RemoveEmptyEntries));
