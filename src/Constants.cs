...
namespace Landis.Library.PnETCohorts 
{
    public class Constants 
    {
        ...
        /// Million
        /// </summary>
        public const float Million = 1.0E6;

        /// <summary>
        /// Billion
        /// </summary>
        public const float Billion = 1.0E9;

        /// <summary>
        /// Seconds per hour
        /// </summary>
        public const float SecondsPerHour = 60.0 * 60.0;

        /// <summary>
        /// Seconds per day
        /// </summary>
        public const float SecondsPerDay = SecondsPerHour * 24.0;
