...
namespace Landis.Library.PnETCohorts
{
    public class Snow
    {
        ...
        /// <returns></returns>
        public float CalcDensity(int daysOfWinter)
        {
        ...
        /// <returns></returns>
        public float CalcDepth(float densitySnow_kg_m3, float snowpack)
        {
        ...
        /// <returns></returns>
        public float CalcThermalConductivity(float densitySnow_kg_m3)
        {
        ...
        /// <returns></returns>
        public float CalcThermalDamping(float thermalConductivity_Snow)
        {
        ...
        /// <returns></returns>
        public float CalcDampingRatio(float snowDepth, float thermalDamping)
        {
