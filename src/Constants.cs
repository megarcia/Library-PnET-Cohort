...
namespace Landis.Library.PnETCohorts 
{
    public class Constants 
    {
        ...
        /// Million
        /// </summary>
        public const float Million = 1.0E6f;

        /// <summary>
        /// Billion
        /// </summary>
        public const float Billion = 1.0E9f;
        ...
        /// <summary>
        /// Mass density of C in g/mol
        /// </summary>
        public const float MC = 12.0f;

        /// <summary>
        /// Mass density of CO2 in g/mol
        /// </summary>
        public const float MCO2 = 44.0f;

        /// <summary>
        /// Ratio of mass density of CO2 to C 
        /// </summary>
        ...
        public const float CalperJ = 1.0f / Jpercal;
        ...
        /// </summary>
        public const float CO2RefConc = 350.0f;

        /// <summary>
        /// convert kJ/m.d.K to W/m.K
        /// </summary>
        public const float Convert_kJperday_to_Watts = 0.2777777778f / 24.0f;
        ...
        /// </summary>
        public const float omega = 2.0f * (float)Math.PI;

        /// <summary>
        /// length of temperature record in months
        /// </summary>
        public const float tau = 12.0f;
