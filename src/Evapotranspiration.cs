...
namespace Landis.Library.PnETCohorts
{
    public class Evapotranspiration
    {
        ...
        /// Formulation generally follows the explanation in:
        /// USACE HEC-HMS Technical Reference Manual
        /// https://www.hec.usace.army.mil/confluence/hmsdocs/hmstrm/evaporation-and-transpiration/hamon-method
        /// including the coefficient value given here for metric units 
        ...
        public static float CalcReferenceET_Hamon(float T, float DayLength)
        {
            ...
            float es = Weather.CalcVaporPressure(T); // in kPa
            float N = DayLength / Constants.SecondsPerHour / 12f;
            float coeff = 0.1651F; // mm/g/m3, from USACE HEC-HMS Technical Reference Manual
            float ReferenceET = k * coeff * 216.7f * N * (10f * es / (T + Constants.Tref_K)); // TODO: verify the k and 10x factors
