...
namespace Landis.Library.PnETCohorts
{
    public interface IProbEstablishment
    {
        ...
        Dictionary<IPnETSpecies, float> CalcProbEstablishmentForMonth(IEcoregionPnETVariables pnetvars, IEcoregionPnET ecoregion, float PAR, IHydrology hydrology, float minHalfSat, float maxHalfSat, bool invertProbEstablishment, float fracRootAboveFrost);
